...
export const BUILDINGS = Object.freeze({
  ...
  greenhouse: { cost: { silica: 10, metal: 8, water: 4 }, power: -4, radius: 26, label: 'Greenhouse', advanced: true, tech: 'habitat-1' },
  reactor: { cost: { metal: 18, salvage: 10, anomaly: 1 }, power: 20, radius: 24, label: 'Aux Reactor', advanced: true, tech: 'energy-1' },
  'deep-drill': { cost: { metal: 12, salvage: 4 }, power: -5, radius: 22, label: 'Deep Ice Drill', advanced: true, tech: 'extraction-1' },
  miner: { cost: { metal: 14, salvage: 6 }, power: -5, radius: 22, label: 'Automated Miner', advanced: true, tech: 'automation-1' },
  'drone-pad': { cost: { metal: 12, silica: 4, salvage: 8 }, power: -4, radius: 24, label: 'Drone Pad', advanced: true, tech: 'automation-1' },
  uplink: { cost: { metal: 10, silica: 8, salvage: 8 }, power: -4, radius: 20, label: 'Orbital Uplink', advanced: true, tech: 'science-1' },
  'cst-relay': { cost: { metal: 12, silica: 8, anomaly: 1 }, power: -4.5, radius: 18, label: 'CST Relay', advanced: true, tech: 'cst-1' },
  'memory-archive': { cost: { metal: 8, silica: 8, salvage: 6 }, power: -2.5, radius: 20, label: 'Memory Archive', advanced: true, tech: 'cst-1' },
  'lattice-hub': { cost: { metal: 18, silica: 12, anomaly: 2 }, power: -6, radius: 28, label: 'Synaptic Lattice Hub', advanced: true, tech: 'cst-2' },
  'settlement-core': { cost: { regolith: 20, metal: 18, silica: 8, salvage: 6 }, power: -5, radius: 34, label: 'Settlement Core', advanced: true, tech: 'habitat-1' },
});
